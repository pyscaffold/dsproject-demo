...
Welcome to ``demo-dsproject`` contributor's guide.
...
If you experience bugs or general issues with ``demo-dsproject``, please have a look
...
You can help improve ``demo-dsproject`` docs by making them more readable and coherent, or
by adding missing information and correcting mistakes.

``demo-dsproject`` documentation uses Sphinx_ as its main documentation compiler.
...
.. todo:: If your project is hosted on GitHub, you can also mention the following tip:
   ...
   .. tip::
      ...
      propose changes in ``demo-dsproject``'s files. While this mechanism can
...
or Miniconda_::
    ...
    conda create -n demo-dsproject python=3 six virtualenv pytest pytest-cov
...
#. Clone this copy to your local disk::
    ...
    git clone git@github.com:YourLogin/demo-dsproject.git
    cd demo-dsproject
...
#. Install |pre-commit|_::
   ...
   ``demo-dsproject`` comes with a lot of hooks configured to automatically help the
...
.. _repository: https://github.com/<USERNAME>/demo-dsproject
.. _issue tracker: https://github.com/<USERNAME>/demo-dsproject/issues
.. <-- end -->
